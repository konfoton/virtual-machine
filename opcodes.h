...
inline const std::unordered_map<std::string, OpCode>& getOpcodeMap() {
    static const std::unordered_map<std::string, OpCode> map = {
        {"nop", OpCode::NOP}, {"halt", OpCode::HALT}, {"syscall", OpCode::SYSCALL},
        {"debug", OpCode::DEBUG}, {"breakpoint", OpCode::BREAKPOINT},
        {"mov", OpCode::MOV}, {"load", OpCode::LOAD}, {"store", OpCode::STORE},
        {"lea", OpCode::LEA}, {"push", OpCode::PUSH}, {"pop", OpCode::POP},
        {"xchg", OpCode::XCHG}, {"movi", OpCode::MOVI}, {"load_const", OpCode::LOAD_CONST},
        {"add", OpCode::ADD}, {"sub", OpCode::SUB}, {"mul", OpCode::MUL},
        {"div", OpCode::DIV}, {"mod", OpCode::MOD}, {"inc", OpCode::INC},
        {"dec", OpCode::DEC}, {"neg", OpCode::NEG}, {"abs", OpCode::ABS},
        {"fadd", OpCode::FADD}, {"fsub", OpCode::FSUB}, {"fmul", OpCode::FMUL},
        {"fdiv", OpCode::FDIV}, {"fmod", OpCode::FMOD}, {"fneg", OpCode::FNEG},
        {"fabs", OpCode::FABS}, {"fsqrt", OpCode::FSQRT}, {"fsin", OpCode::FSIN},
        {"fcos", OpCode::FCOS}, {"fpow", OpCode::FPOW},
        {"itof", OpCode::ITOF}, {"ftoi", OpCode::FTOI},
        {"itos", OpCode::ITOS}, {"ftos", OpCode::FTOS},
        {"and", OpCode::AND}, {"or", OpCode::OR}, {"xor", OpCode::XOR},
        {"not", OpCode::NOT}, {"shl", OpCode::SHL}, {"shr", OpCode::SHR},
        {"sar", OpCode::SAR}, {"rol", OpCode::ROL}, {"ror", OpCode::ROR},
        {"cmp", OpCode::CMP}, {"fcmp", OpCode::FCMP}, {"test", OpCode::TEST},
        {"jmp", OpCode::JMP}, {"jz", OpCode::JZ}, {"jnz", OpCode::JNZ},
        {"jg", OpCode::JG}, {"jl", OpCode::JL}, {"jge", OpCode::JGE},
        {"jle", OpCode::JLE}, {"jo", OpCode::JO}, {"jno", OpCode::JNO},
        {"loop", OpCode::LOOP},
        {"call", OpCode::CALL}, {"ret", OpCode::RET},
        {"enter", OpCode::ENTER}, {"leave", OpCode::LEAVE},
        {"dup", OpCode::DUP}, {"swap", OpCode::SWAP}, {"rot", OpCode::ROT},
        {"depth", OpCode::DEPTH}, {"pick", OpCode::PICK},
        {"alloc", OpCode::ALLOC}, {"free", OpCode::FREE}, {"realloc", OpCode::REALLOC},
        {"memcpy", OpCode::MEMCPY}, {"memset", OpCode::MEMSET},
        {"loadh", OpCode::LOADH}, {"storeh", OpCode::STOREH},
        {"print", OpCode::PRINT}, {"println", OpCode::PRINTLN},
        {"prints", OpCode::PRINTS}, {"input", OpCode::INPUT},
        {"inputf", OpCode::INPUTF}, {"inputs", OpCode::INPUTS},
        {"try", OpCode::TRY}, {"endtry", OpCode::ENDTRY}, {"throw", OpCode::THROW},
        {"anew", OpCode::ANEW}, {"aget", OpCode::AGET},
        {"aset", OpCode::ASET}, {"alen", OpCode::ALEN},
        {"gc_collect", OpCode::GC_COLLECT}, {"gc_on", OpCode::GC_ON},
        {"gc_off", OpCode::GC_OFF}, {"gc_stats", OpCode::GC_STATS},
        {"dump_regs", OpCode::DUMP_REGS}, {"dump_stack", OpCode::DUMP_STACK},
        {"dump_heap", OpCode::DUMP_HEAP},
        {"trace_on", OpCode::TRACE_ON}, {"trace_off", OpCode::TRACE_OFF},
    };
    return map;
}
...
inline const char* opcodeName(OpCode op) {
    switch (op) {
        ...
        case OpCode::SYSCALL: return "SYSCALL"; case OpCode::DEBUG: return "DEBUG";
        case OpCode::BREAKPOINT: return "BREAKPOINT";
        case OpCode::MOV: return "MOV"; case OpCode::LOAD: return "LOAD";
        case OpCode::STORE: return "STORE"; case OpCode::LEA: return "LEA";
        case OpCode::PUSH: return "PUSH"; case OpCode::POP: return "POP";
        case OpCode::XCHG: return "XCHG"; case OpCode::MOVI: return "MOVI";
        case OpCode::LOAD_CONST: return "LOAD_CONST";
        case OpCode::ADD: return "ADD"; case OpCode::SUB: return "SUB";
        case OpCode::MUL: return "MUL"; case OpCode::DIV: return "DIV";
        case OpCode::MOD: return "MOD"; case OpCode::INC: return "INC";
        case OpCode::DEC: return "DEC"; case OpCode::NEG: return "NEG";
        case OpCode::ABS: return "ABS";
        case OpCode::FADD: return "FADD"; case OpCode::FSUB: return "FSUB";
        case OpCode::FMUL: return "FMUL"; case OpCode::FDIV: return "FDIV";
        case OpCode::FMOD: return "FMOD"; case OpCode::FNEG: return "FNEG";
        case OpCode::FABS: return "FABS"; case OpCode::FSQRT: return "FSQRT";
        case OpCode::FSIN: return "FSIN"; case OpCode::FCOS: return "FCOS";
        case OpCode::FPOW: return "FPOW";
        case OpCode::ITOF: return "ITOF"; case OpCode::FTOI: return "FTOI";
        case OpCode::ITOS: return "ITOS"; case OpCode::FTOS: return "FTOS";
        ...
        case OpCode::CMP: return "CMP"; case OpCode::FCMP: return "FCMP";
        case OpCode::TEST: return "TEST";
        case OpCode::JMP: return "JMP"; case OpCode::JZ: return "JZ";
        case OpCode::JNZ: return "JNZ"; case OpCode::JG: return "JG";
        case OpCode::JL: return "JL"; case OpCode::JGE: return "JGE";
        case OpCode::JLE: return "JLE"; case OpCode::JO: return "JO";
        case OpCode::JNO: return "JNO"; case OpCode::LOOP: return "LOOP";
        case OpCode::CALL: return "CALL"; case OpCode::RET: return "RET";
        case OpCode::ENTER: return "ENTER"; case OpCode::LEAVE: return "LEAVE";
        case OpCode::DUP: return "DUP"; case OpCode::SWAP: return "SWAP";
        case OpCode::ROT: return "ROT"; case OpCode::DEPTH: return "DEPTH";
        case OpCode::PICK: return "PICK";
        case OpCode::ALLOC: return "ALLOC"; case OpCode::FREE: return "FREE";
        case OpCode::REALLOC: return "REALLOC"; case OpCode::MEMCPY: return "MEMCPY";
        case OpCode::MEMSET: return "MEMSET"; case OpCode::LOADH: return "LOADH";
        case OpCode::STOREH: return "STOREH";
        case OpCode::PRINT: return "PRINT"; case OpCode::PRINTLN: return "PRINTLN";
        case OpCode::PRINTS: return "PRINTS"; case OpCode::INPUT: return "INPUT";
        case OpCode::INPUTF: return "INPUTF"; case OpCode::INPUTS: return "INPUTS";
        case OpCode::TRY: return "TRY"; case OpCode::ENDTRY: return "ENDTRY";
        case OpCode::THROW: return "THROW";
        case OpCode::ANEW: return "ANEW"; case OpCode::AGET: return "AGET";
        case OpCode::ASET: return "ASET"; case OpCode::ALEN: return "ALEN";
        case OpCode::GC_COLLECT: return "GC_COLLECT"; case OpCode::GC_ON: return "GC_ON";
        case OpCode::GC_OFF: return "GC_OFF"; case OpCode::GC_STATS: return "GC_STATS";
        case OpCode::DUMP_REGS: return "DUMP_REGS"; case OpCode::DUMP_STACK: return "DUMP_STACK";
        case OpCode::DUMP_HEAP: return "DUMP_HEAP";
        case OpCode::TRACE_ON: return "TRACE_ON"; case OpCode::TRACE_OFF: return "TRACE_OFF";
